...
class _WebHighlightWidgetState extends State<WebHighlightWidget> {
  // Use the aliased CarouselSliderController from carousel_slider
          ...
          children: [
            ...
            Column(
              children: [
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: robotoRegular.copyWith(
                              color: Get.isDarkMode ? Colors.white70 : Theme.of(context).hintColor,
                ...
                carousel_slider.CarouselSlider.builder( // Use aliased CarouselSlider
                  carouselController: _carouselController, // Use the CarouselSliderController
                  itemCount: advertisementController.advertisementList!.length,
                  options: carousel_slider.CarouselOptions( // Use aliased CarouselOptions
                    ...
                    autoPlay: advertisementController.advertisementList!.length > 2
