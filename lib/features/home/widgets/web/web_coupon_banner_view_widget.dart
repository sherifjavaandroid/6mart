import 'package:carousel_slider/carousel_slider.dart'; // Only import carousel_slider
import 'package:carousel_slider/carousel_controller.dart'; // No longer needed, remove this
...
class _WebCouponBannerViewWidgetState extends State<WebCouponBannerViewWidget> {
  // Use the new CarouselSliderController
        ...
        child: Column(
          children: [
            CarouselSlider.builder(
              carouselController: carouselController, // Use the new CarouselSliderController
